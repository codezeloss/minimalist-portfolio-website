...
const GetInTouch = () => {
  return (
    <section className="mt-[94px] flex flex-row justify-between border-t-[1px] border-dark-blue/[.15]">
      <h2 className="mt-[48px]">Get in Touch</h2>

      <div className="mt-[48px] flex flex-col justify-start">
        <p className="p-body1 w-[635px]">
